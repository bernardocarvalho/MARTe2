 ...
 *     *CpuMask = 0x1 (the cpus where the internal thread is allowed to run)
 *     *ReceiverThreadPriority = 0-31 (the priority of the internal thread)
 *     Signals = {
 *         *InternalTimeStamp = {
 *             Type = uint64
...
public:
     ...
     *   isRefreshed = new uint8[numberOfSignals*numberOfBuffers];\n
     */
