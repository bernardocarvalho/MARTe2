/**
 * @file SenderStructuredData.h
 * @brief Header file for class SenderStructuredData
 * @date 06 set 2018
 * @author pc
 *
 ...
 * @details This header file contains the declaration of the class SenderStructuredData
 * with all of its public, protected and private members. It may also include
 * definitions for inline methods which need to be visible to the compiler.
 */

#ifndef SENDERSTRUCTUREDDATA_H_
#define SENDERSTRUCTUREDDATA_H_
