/**
 * @file RealTimeApplicationLightConfigBuilderTest.h
 * @brief Header file for class RealTimeApplicationLightConfigBuilderTest
 * @date 22 ago 2019
 * @author pc
 *
 ...
 * @details This header file contains the declaration of the class RealTimeApplicationLightConfigBuilderTest
 * with all of its public, protected and private members. It may also include
 * definitions for inline methods which need to be visible to the compiler.
 */

#ifndef TEST_CORE_BAREMETAL_L5GAMS_REALTIMEAPPLICATIONLIGHTCONFIGBUILDERTEST_H_
#define TEST_CORE_BAREMETAL_L5GAMS_REALTIMEAPPLICATIONLIGHTCONFIGBUILDERTEST_H_
...
class RealTimeApplicationLightConfigBuilderTest {
public:
    RealTimeApplicationLightConfigBuilderTest();
    virtual ~RealTimeApplicationLightConfigBuilderTest();
...
#endif /* TEST_CORE_BAREMETAL_L5GAMS_REALTIMEAPPLICATIONLIGHTCONFIGBUILDERTEST_H_ */
