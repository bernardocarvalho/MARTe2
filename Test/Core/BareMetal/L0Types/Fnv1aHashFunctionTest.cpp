...
Fnv1aHashFunctionTest::Fnv1aHashFunctionTest() {
    // Auto-generated constructor stub for Fnv1aHashFunctionTest
    // TODO Verify if manual additions are needed
}

Fnv1aHashFunctionTest::~Fnv1aHashFunctionTest() {
    // Auto-generated destructor stub for Fnv1aHashFunctionTest
    // TODO Verify if manual additions are needed
}
...
bool Fnv1aHashFunctionTest::TestCompute(const char8 *in,
                                        uint32 size,
                                        uint32 result) {
