/**
 * @file ReferenceContainerFilterNameAndTypeGTest.cpp
 * @brief Source file for class ReferenceContainerFilterNameAndTypeGTest
 * @date 27 ago 2018
 * @author pc
 *
 ...
 * the class ReferenceContainerFilterNameAndTypeGTest (public, protected, and private). Be aware that some 
