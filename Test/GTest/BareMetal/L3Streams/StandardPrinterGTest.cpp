/**
 * @file StrandardPrinterGTest.cpp
 * @brief Source file for class StrandardPrinterGTest
 * @date 18 set 2018
 * @author pc
 *
 ...
 * the class StrandardPrinterGTest (public, protected, and private). Be aware that some 
